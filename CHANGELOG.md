...
## [2.0.8.4b] - 20 Dec, 2021
### Fixed
- Orange icons displaying in Odyssey

## [2.0.8.4] - 18 Dec, 2021
### Added
- Clean_Slate theme for Odyssey
- Red_Dragon_Red theme for Odyssey
- Game location helper

### Changed
- Updated Cherenkov_Blue theme for Odyssey
- Updated Holiday Blue theme for Odyssey
- Updated Red Gray Black theme for Odyssey
- Updated EDHM Horizons library to 1.52
- Auto-updater codebase
...
## [2.0.8.2] - 11 Dec, 2021
### Added
- Icon skinning support

### Changed
- Updated EDHM library to 9.0

## [2.0.8.0] - 07 Dec, 2021
### Added
- UI translations for ES, DE, FR, PT, RU

### Changed
- Updated EDHM library to 8.4
...
- RedGrayBlack theme
- OrangeBloo theme
- SebiLetPlay's Green theme
- Cherenkov_Blue theme
