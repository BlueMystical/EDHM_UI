namespace EDHM_UI_mk2
{
	partial class GameFolderForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.repGameFolderSelector = new DevExpress.XtraEditors.Repository.RepositoryItemButtonEdit();
			this.gridControl1 = new DevExpress.XtraGrid.GridControl();
			this.gridView1 = new DevExpress.XtraGrid.Views.Grid.GridView();
			this.gridColumn1 = new DevExpress.XtraGrid.Columns.GridColumn();
			this.layoutControl1 = new DevExpress.XtraLayout.LayoutControl();
			this.cmdCleanInstall = new DevExpress.XtraEditors.SimpleButton();
			this.txtUserDataFolder = new DevExpress.XtraEditors.ButtonEdit();
			...
			this.chkSettings_GreetMe = new DevExpress.XtraEditors.CheckEdit();
			this.chkSettings_HideToTray = new DevExpress.XtraEditors.CheckEdit();
			...
			((System.ComponentModel.ISupportInitialize)(this.txtUserDataFolder.Properties)).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.chkSettings_HideToTray.Properties)).BeginInit();
			...
			// gridView2
			// 
			this.gridView2.Appearance.EvenRow.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(0)))), ((int)(((byte)(64)))), ((int)(((byte)(64)))));
			this.gridView2.Appearance.EvenRow.Options.UseBackColor = true;
			this.gridView2.Appearance.OddRow.BackColor = System.Drawing.Color.MidnightBlue;
			...
			// gridColumn3
			// 
			this.gridColumn3.Caption = "Game Path";
			this.gridColumn3.ColumnEdit = this.repGameFolderSelector;
			...
			// 
			// repGameFolderSelector
			// 
			this.repGameFolderSelector.AutoHeight = false;
			this.repGameFolderSelector.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.repGameFolderSelector.Name = "repGameFolderSelector";
			this.repGameFolderSelector.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.repGameFolderSelector_ButtonClick);
			// 
			// gridControl1
			// 
			gridLevelNode1.LevelTemplate = this.gridView2;
			gridLevelNode1.RelationName = "games";
			...
			this.gridView1.Appearance.HideSelectionRow.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(255)))), ((int)(((byte)(128)))), ((int)(((byte)(0)))));
			...
			// gridColumn1
			// 
			this.gridColumn1.Caption = "Instance Name";
			this.gridColumn1.FieldName = "instance";
			...
			// layoutControl1
			// 
			this.layoutControl1.Controls.Add(this.cmdCleanInstall);
			this.layoutControl1.Controls.Add(this.txtUserDataFolder);
			...
			this.layoutControl1.Controls.Add(this.cmdHelp);
			this.layoutControl1.Controls.Add(this.cboLanguages);
			this.layoutControl1.Controls.Add(this.chkSettings_GreetMe);
			this.layoutControl1.Controls.Add(this.chkSettings_HideToTray);
			this.layoutControl1.Controls.Add(this.cmdSaveChanges);
			this.layoutControl1.Dock = System.Windows.Forms.DockStyle.Fill;
			this.layoutControl1.Location = new System.Drawing.Point(0, 0);
			this.layoutControl1.Name = "layoutControl1";
			this.layoutControl1.Root = this.Root;
			this.layoutControl1.Size = new System.Drawing.Size(894, 609);
			this.layoutControl1.TabIndex = 0;
			this.layoutControl1.Text = "layoutControl1";
			// 
			// cmdCleanInstall
			// 
			this.cmdCleanInstall.ImageOptions.SvgImage = ((DevExpress.Utils.Svg.SvgImage)(resources.GetObject("cmdCleanInstall.ImageOptions.SvgImage")));
			this.cmdCleanInstall.Location = new System.Drawing.Point(307, 320);
			this.cmdCleanInstall.Name = "cmdCleanInstall";
			this.cmdCleanInstall.Size = new System.Drawing.Size(128, 36);
			this.cmdCleanInstall.StyleController = this.layoutControl1;
			this.cmdCleanInstall.TabIndex = 20;
			this.cmdCleanInstall.Text = "Clean Install";
			this.cmdCleanInstall.Click += new System.EventHandler(this.cmdCleanInstall_Click);
			// 
			// txtUserDataFolder
			// 
			this.txtUserDataFolder.Location = new System.Drawing.Point(446, 485);
			this.txtUserDataFolder.Name = "txtUserDataFolder";
			this.txtUserDataFolder.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] {
            new DevExpress.XtraEditors.Controls.EditorButton()});
			this.txtUserDataFolder.Size = new System.Drawing.Size(424, 20);
			this.txtUserDataFolder.StyleController = this.layoutControl1;
			this.txtUserDataFolder.TabIndex = 19;
			this.txtUserDataFolder.ButtonClick += new DevExpress.XtraEditors.Controls.ButtonPressedEventHandler(this.txtUserDataFolder_ButtonClick);
			// 
			// chkAutoApplyTheme
			// 
    ...
    "me window, making it to refresh the colors.";
            ...
            0,
            0});
			this.txtSavesToRememberRep.Location = new System.Drawing.Point(587, 509);
			...
			this.cmdRemoveInstance.Location = new System.Drawing.Point(195, 320);
			this.cmdRemoveInstance.Name = "cmdRemoveInstance";
			this.cmdRemoveInstance.Size = new System.Drawing.Size(108, 36);
			...
			this.cmdAddGameInstance.Location = new System.Drawing.Point(24, 320);
			this.cmdAddGameInstance.Name = "cmdAddGameInstance";
			this.cmdAddGameInstance.Size = new System.Drawing.Size(167, 36);
    ...
    " of those would be an \'instance\'.";
			...
			// cmdHelp
			// 
			this.cmdHelp.Appearance.BackColor = System.Drawing.Color.Green;
			this.cmdHelp.Appearance.ForeColor = System.Drawing.Color.Black;
			...
			this.cmdHelp.Location = new System.Drawing.Point(600, 320);
			this.cmdHelp.Name = "cmdHelp";
			this.cmdHelp.Size = new System.Drawing.Size(270, 36);
			this.cmdHelp.StyleController = this.layoutControl1;
			toolTipTitleItem3.Text = "Click Me";
			superToolTip4.Items.Add(toolTipTitleItem3);
			this.cmdHelp.SuperTip = superToolTip4;
			this.cmdHelp.TabIndex = 12;
			this.cmdHelp.Text = "Game Localizator Assistant";
			...
			// cmdSaveChanges
			// 
			this.cmdSaveChanges.Appearance.BackColor = System.Drawing.Color.FromArgb(((int)(((byte)(192)))), ((int)(((byte)(64)))), ((int)(((byte)(0)))));
			this.cmdSaveChanges.Appearance.Options.UseBackColor = true;
			...
			this.cmdSaveChanges.Location = new System.Drawing.Point(632, 561);
			this.cmdSaveChanges.Name = "cmdSaveChanges";
			this.cmdSaveChanges.Size = new System.Drawing.Size(250, 36);
			this.cmdSaveChanges.StyleController = this.layoutControl1;
			this.cmdSaveChanges.TabIndex = 6;
			...
			this.Root.Name = "Root";
			this.Root.Size = new System.Drawing.Size(894, 609);
			this.Root.TextVisible = false;
			// 
			// layoutControlItem3
			// 
			this.layoutControlItem3.Control = this.cmdSaveChanges;
			this.layoutControlItem3.Location = new System.Drawing.Point(620, 549);
			this.layoutControlItem3.Name = "layoutControlItem3";
			this.layoutControlItem3.Size = new System.Drawing.Size(254, 40);
			...
			this.emptySpaceItem2.Size = new System.Drawing.Size(620, 40);
			...
			this.layoutControlGroup1.Size = new System.Drawing.Size(874, 189);
			this.layoutControlGroup1.Text = "Settings:";
			// 
			// layoutControlItem6
			// 
			this.layoutControlItem6.Control = this.chkSettings_GreetMe;
			this.layoutControlItem6.Location = new System.Drawing.Point(0, 0);
			this.layoutControlItem6.Name = "layoutControlItem6";
			this.layoutControlItem6.Size = new System.Drawing.Size(422, 48);
			this.layoutControlItem6.TextSize = new System.Drawing.Size(0, 0);
			this.layoutControlItem6.TextVisible = false;
			// 
			// layoutControlItem5
			// 
			this.layoutControlItem5.Control = this.chkSettings_HideToTray;
			this.layoutControlItem5.Location = new System.Drawing.Point(0, 48);
			this.layoutControlItem5.Name = "layoutControlItem5";
			this.layoutControlItem5.Size = new System.Drawing.Size(422, 48);
			...
			this.txtSavesToRemember.Location = new System.Drawing.Point(422, 104);
			...
			this.emptySpaceItem4.Location = new System.Drawing.Point(422, 128);
			this.emptySpaceItem4.Name = "emptySpaceItem4";
			this.emptySpaceItem4.Size = new System.Drawing.Size(428, 16);
			this.emptySpaceItem4.TextSize = new System.Drawing.Size(0, 0);
			// 
			// emptySpaceItem1
			// 
			this.emptySpaceItem1.AllowHotTrack = false;
			this.emptySpaceItem1.Location = new System.Drawing.Point(636, 104);
			...
			// layoutControlItem4
			// 
			this.layoutControlItem4.Control = this.txtUserDataFolder;
			this.layoutControlItem4.Location = new System.Drawing.Point(422, 64);
			this.layoutControlItem4.Name = "layoutControlItem4";
			this.layoutControlItem4.Size = new System.Drawing.Size(428, 40);
			this.layoutControlItem4.Text = "Themes and User Data:";
			...
			this.layoutControlGroup2.Size = new System.Drawing.Size(874, 360);
			this.layoutControlGroup2.Text = "Game Locations:";
			// 
			// layoutControlItem9
			// 
			this.layoutControlItem9.Control = this.cmdHelp;
			this.layoutControlItem9.Location = new System.Drawing.Point(576, 275);
			...
			this.emptySpaceItem3.Location = new System.Drawing.Point(415, 275);
			this.emptySpaceItem3.Name = "emptySpaceItem3";
			this.emptySpaceItem3.Size = new System.Drawing.Size(161, 40);
			...
			this.layoutControlItem10.Size = new System.Drawing.Size(850, 275);
			...
			this.layoutControlItem11.Size = new System.Drawing.Size(171, 40);
			...
			this.layoutControlItem12.Location = new System.Drawing.Point(171, 275);
			...
			// layoutControlItem7
			// 
			this.layoutControlItem7.Control = this.cmdCleanInstall;
			this.layoutControlItem7.Location = new System.Drawing.Point(283, 275);
			...
			// lblPi
			// 
			this.lblPi.Location = new System.Drawing.Point(857, 296);
			this.lblPi.Name = "lblPi";
			this.lblPi.Size = new System.Drawing.Size(7, 13);
			this.lblPi.TabIndex = 1;
			this.lblPi.Text = "π";
			this.lblPi.MouseDown += new System.Windows.Forms.MouseEventHandler(this.lblPi_MouseDown);
			// 
			// GameFolderForm
			// 
			...
			this.Name = "GameFolderForm";
			this.StartPosition = System.Windows.Forms.FormStartPosition.CenterScreen;
			this.Text = "Settings";
			this.FormClosing += new System.Windows.Forms.FormClosingEventHandler(this.GameFolderForm_FormClosing);
			this.Load += new System.EventHandler(this.GameFolderForm_Load);
			this.Shown += new System.EventHandler(this.GameFolderForm_Shown);
			((System.ComponentModel.ISupportInitialize)(this.gridView2)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.repGameFolderSelector)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridControl1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.gridView1)).EndInit();
			((System.ComponentModel.ISupportInitialize)(this.layoutControl1)).EndInit();
			this.layoutControl1.ResumeLayout(false);
			((System.ComponentModel.ISupportInitialize)(this.txtUserDataFolder.Properties)).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)(this.chkSettings_HideToTray.Properties)).EndInit();
		...
		private DevExpress.XtraEditors.CheckEdit chkSettings_GreetMe;
		private DevExpress.XtraEditors.CheckEdit chkSettings_HideToTray;
		...
		private DevExpress.XtraEditors.SimpleButton cmdHelp;
		...
		private DevExpress.XtraEditors.Repository.RepositoryItemButtonEdit repGameFolderSelector;
		private DevExpress.XtraEditors.SimpleButton cmdRemoveInstance;
		...
		private DevExpress.XtraEditors.ButtonEdit txtUserDataFolder;
		private DevExpress.XtraLayout.LayoutControlItem layoutControlItem4;
		private DevExpress.XtraEditors.SimpleButton cmdCleanInstall;
