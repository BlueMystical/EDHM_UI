namespace elite_dangerous_64
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.cmdEmbark = new System.Windows.Forms.Button();
			this.SuspendLayout();
			// 
			// label1
			// 
			...
			this.label1.Size = new System.Drawing.Size(1083, 20);
			...
			this.comboBox1.Location = new System.Drawing.Point(950, 29);
			...
			// cmdEmbark
			// 
			this.cmdEmbark.Location = new System.Drawing.Point(996, 56);
			this.cmdEmbark.Name = "cmdEmbark";
			this.cmdEmbark.Size = new System.Drawing.Size(75, 23);
			this.cmdEmbark.TabIndex = 4;
			this.cmdEmbark.Text = "Embark";
			this.cmdEmbark.UseVisualStyleBackColor = true;
			this.cmdEmbark.Click += new System.EventHandler(this.cmdEmbark_Click);
			// 
			// Form1
			// 
			...
			this.Controls.Add(this.cmdEmbark);
		...
		private System.Windows.Forms.Button cmdEmbark;
	}
}
