...
var Color = function () {
    ...
    createClass(Color, [{
        ...
        get: function get() {
            ...
            //-- NEW METHOD: Returns a HEX string in '#RRGGBBAA' format Uppercased.
            ...
            const rHex = componentToHex(this.rgba[0]);
            const gHex = componentToHex(this.rgba[1]);
            const bHex = componentToHex(this.rgba[2]);
        ...
        value: function hexToRgb(input) {
            //-- NEW METHOD: Returns an Array of RGBA color components, the Alpha is in the range of 0-1
            try {
                // Remove the hash sign if present and convert to lowercase for uniformity
                var hexColor = input.replace("#", "").toLowerCase();
                ...
                var rgba = [r, g, b, a];
                rgba[3] = rgba[3] / 255;
                //console.log('Hex: ' + input +', RGBA:', rgba);
                return rgba;
            } catch (error) {
                console.log(error)
            }
